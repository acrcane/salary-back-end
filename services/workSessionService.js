...
export const checkInService = async (tableId, userId, checkInTime) => {
  ...
  if (activeSession) throw HttpError(400, 'Check out first');
...
export const checkOutService = async (sessionId, checkOutTime) => {
...
export const workSessionActiveService = async (userId) => {
